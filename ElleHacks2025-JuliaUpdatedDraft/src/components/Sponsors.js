    ...
    <div className="mt-20 font-[Faustina] h-auto px-4 mx-auto lg:mx-20 xl:mx-64 mb-32 select-none w-full max-w-screen-xl">
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col gap-4 mb-8 items-center justify-center">
          <div className="w-full h-24 bg-white rounded-full flex justify-center items-center">
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-4 mb-8 justify-center">
          <div className="w-32 h-20 md:w-44 md:h-24 bg-white rounded-full flex justify-center items-center">
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-4 mb-8 justify-center">
          <div className="w-32 h-20 md:w-44 md:h-24 bg-white rounded-full flex justify-center items-center">
            <img src={Reactor} alt="Community Sponsor" className="h-8 sm:h-12 object-contain" />
          </div>
          <div className="w-32 h-20 md-44 md:h-24 bg-white rounded-full flex justify-center items-center">
            <img src={BramptionInnovationDistrict} alt="Community Sponsor" className="h-8 sm:h-12 object-contain" />
          </div>
          <div className="w-32 h-20 md:w-44 sm:h-24 bg-white rounded-full flex justify-center items-center">
            <img src={StickerMule} alt="Community Sponsor" className="h-8 sm:h-12 object-contain" />
          </div>
          <div className="w-32 h-20 md:w-44 sm:h-24 bg-white rounded-full flex justify-center items-center">
            <img src={ySpace} alt="Community Sponsor" className="h-8 sm:h-12 object-contain" />
          </div>
        </div>
      </div>
    </div>
