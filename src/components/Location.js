...
function Location() {
  return (
    <div className="flex justify-center items-center font-[Faustina] sm:h-[90vh] md:h-[50vh]  p-5 bg-[#899878] text-[#EDDEC9] select-none">
      <div className="w-full max-w-[1050px] text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          ...
          <div className="flex-1 sm:w-[45%] text-center sm:text-left">
            <h1 className="text-6xl sm:text-7xl md:text-6xl lg:text-8xl mt-10 mb-6 font-bold">Location</h1>
          ...
          {/* Google Map Section*/}
          <div className="flex-1 sm:w-[70%] relative pb-[56.25%] sm:pb-[30%] overflow-hidden rounded-lg shadow-lg mb-6 sm:mb-0">
            <iframe
